...
//	Compress(reader io.Reader) (gzipReader io.Reader, len int64, err error)
...
//
//func WrapReader(reader io.Reader) (io.Reader, int64, error) {
...
//
//func GetReaderLength(reader io.Reader) (int64, error) {
//	// 保存当前的读写位置
